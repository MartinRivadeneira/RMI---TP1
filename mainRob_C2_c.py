        ...
        try:
            ...
            while MAP_for_path[list_non_visited_j[idx], list_non_visited_i[idx]] == 0:
                ...
                for z in range(0, len(list_possivel_go_j)):
                    print(MAP_np[list_possivel_go_j[z], list_possivel_go_i[z]])

                    sides_array1 = np.array([[0, MAP_np[list_possivel_go_j[z] - 1, list_possivel_go_i[z]], 0],
                                             [MAP_np[list_possivel_go_j[z], list_possivel_go_i[z] - 1],
                                              MAP_np[list_possivel_go_j[z], list_possivel_go_i[z]],
                                              MAP_np[list_possivel_go_j[z], list_possivel_go_i[z] + 1]],
                                             [0, MAP_np[list_possivel_go_j[z] + 1, list_possivel_go_i[z]], 0]])
                    print(sides_array1)
                ...
                iteration += 1
                # print(iteration)
                print('Final cell = ' + str(MAP_for_path[list_non_visited_j[idx], list_non_visited_i[idx]]))
                print('The final cell is =' + str(list_non_visited_j[idx]) + ', ' + str(list_non_visited_i[idx]))
                print('Initial cell = ' + str(MAP_for_path[actual_position_j, actual_position_i]))
                if iteration >= 50:
                    break
            print('Im done')
            print(MAP_for_path)
